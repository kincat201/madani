                            ...
                            <tbody>
                                                    ...
                                                    <td>
                                                        <table class="logo" align="center" border="0" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center">
                                                                        <a href="{{route('home')}}" style="display: block;"><img  style="display: block;" src="{{ @$message->embed(public_path('storage'.'/'.$CONF->logo)) }}" alt="logo" width="155"></a>
                                                                        {{--<a href="{{route('home')}}" style="display: block;"><img  style="display: block;" src="{{ url('storage'.'/'.$CONF->logo) }}" alt="logo" width="155"></a>--}}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="color: #484848; font-size: 12px; line-height:20px; font-family: Helvetica, Arial, sans-serif; text-align:justify;">
                                                                    Demikian informasi ini kami sampaikan. Untuk informasi lebih lanjut mengenai hal ini silakan hubungi kami melalui <b>{{$CONF->email}}</b> atau klik <a href="https://api.whatsapp.com/send?phone={{$CONF->whatsapp}}&amp;text=Halo%20Admin%20Saya%20Ingin%20Bertanya%20terkait%20JSIT%20Commerce" target="_blank">di sini</a> untuk langsung chat Admin<br>
                                                                    <br>
                                                                    Salam Hangat,<br>
                                                                    ...
                                                                    <td  style="font-size: 13px; font-family: Helvetica, Arial, sans-serif;" align="center">
                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                    --}}{{--    <a style="display: block; width: 16px;" href="{{ @$other_setting->google_acc }}" target="_blank"><img  style="display: block;" src="{{ @$message->embed(storage_path('assets/img/email-img/social-google.png')) }}" alt="google plus" width="16"></a>--}}{{--
                                                                                        <a style="display: block; width: 16px;" href="{{ @$CONF->facebook }}" target="_blank"><img  style="display: block;" src="{{ url('frontend/images/email-img/social-google.png') }}" alt="Facebook" width="16"></a>
                                                                                    </td>
                                                                                    <td>&nbsp;&nbsp;&nbsp;</td>
                                                                                </tr>
                                                                            </tbody>
                                ...
                                <tr>
                                    <td  style="color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-subheader" align="center">
                                        ...
                                        <span style="color: #7087A3">Adress :</span>{{ @$CONF->address }}<br> &nbsp;&nbsp;&nbsp;   <span style="color: #7087A3">Phone :</span> {{ @$CONF->phone }}    &nbsp;&nbsp;&nbsp;<span style="color: #7087A3">Email :</span> {{ @$CONF->email }}
